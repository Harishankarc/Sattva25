        ...
        <div className="h-screen w-screen arts relative" id="arts">
            <div className="py-20 relative z-10">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <Slide direction='down' triggerOnce><h2 className="text-4xl font-bold text-center mb-12 text-white">ARTS</h2></Slide>
                                ...
                                <tbody>
                                    {branchPoints.map((branch, index) => (
                                        <tr key={index} className="border-b border-gray-700 bg-zinc-900/50">
                                            <td className="py-4 px-6 font-medium text-gray-300">{branch.branch.toUpperCase()}</td>
