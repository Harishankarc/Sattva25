        ...
        <div className="h-screen w-screen sports relative">
            <div className="py-20 relative z-10">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold text-center mb-12 text-white">SPORTS</h2>
                    ...
                    <button className="cursor-pointer text-white mt-10 bg-transparent border border-white px-20 rounded-md py-5 hover:bg-white hover:text-black"><Link to="/sports">Individual Point</Link></button>
                    </div>
