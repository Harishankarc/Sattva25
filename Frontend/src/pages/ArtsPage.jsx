              ...
              <table className="w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-200">
                    ...
                    <th className="border border-gray-300 p-2 whitespace-nowrap">Participant Code</th>
                ...
                <tbody>
                  {result.map((result, index) => (
                    <tr key={index} className="text-center">
                      ...
                      <td className="border border-gray-300 p-2">{result.participant_code.toUpperCase()}</td>
                      <td className="border border-gray-300 p-2">{result.name}</td>
                      <td className="border border-gray-300 p-2">{result.mark}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
